...
* The `director_uuid` option set the [Bosh Director](/bosh/glossary.html#director) to use. We will use the Micro Bosh Director UUID. You can get it running the command `bosh status`.
